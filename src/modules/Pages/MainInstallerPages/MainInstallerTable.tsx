...
interface MainInstallerTableProps {
    ...
    handleCommentChange: (event: React.ChangeEvent<HTMLInputElement>, orderId: string) => void; // Updated to HTMLInputElement
    handleChange: (event: React.ChangeEvent<HTMLSelectElement>, orderId: string) => void; // Updated to HTMLSelectElement
